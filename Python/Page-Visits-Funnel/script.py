...
# number of visits that didn't result in an item being added to cart
...
# number of visits that did result in an item being added to cart, but not purchased
...
cart_not_checkout = cart.merge(checkout, how = 'left')
print(cart_checkout.head())
